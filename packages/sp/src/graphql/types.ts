...
export function getSdk(
  ...
  return {
    UserOnly(
      variables?: UserOnlyQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<UserOnlyQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserOnlyQuery>(UserOnlyDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "UserOnly",
    ...
    ProfileOnly(
      variables?: ProfileOnlyQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ProfileOnlyQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProfileOnlyQuery>(ProfileOnlyDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "ProfileOnly",
    ...
    UserInfo(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserInfoQuery>(UserInfoDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "UserInfo",
    ...
    Profile(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProfileMutation>(ProfileDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Profile",
